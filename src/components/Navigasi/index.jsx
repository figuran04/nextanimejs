    ...
    <div className="flex font-semibold justify-between text-lg fixed bottom-0 left-0 w-screen navigasi">
      <div className="grid grid-cols-3 justify-around items-end w-full h-28">
        ...
        <div className="w-full flex justify-center bg-white">
          <div className="bg-gray-950 rounded-full py-3 px-6 fixed bottom-7 cursor-pointer hover:scale-110 transition-all">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <div className="w-full py-2 pl-2 border-t-2 bg-white">
          ...
          >
            ...
            {showDropup && (
              <div className="dropdown-content rounded-md px-2">
                <div>
                  <Link href="/kursus" className="flex gap-2 py-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                  ...
                  <Link href="/berita" className="flex gap-2 py-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
                  ...
                  <Link href="pengaturan" className="flex gap-2 py-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      fill="currentColor"
