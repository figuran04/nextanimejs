...
const Beranda = async () => {
  ...
  return (
    <div className={`min-h-screen`}>
      ...
      <div
        className={`grid grid-cols-2 gap-2 ${primaryColor} px-4 pb-6 pt-2  sticky top-0 rounded-bl-3xl rounded-br-3xl`}
      >
        <Link
          href="/kursus"
          className="bg-gray-300 hover:bg-gray-400 transition-all rounded-md flex flex-wrap justify-center py-1 text-gray-950"
        >
          <svg
